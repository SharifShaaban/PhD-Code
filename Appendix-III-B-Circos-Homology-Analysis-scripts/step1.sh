...
do
    ...
    python ./background/prophage_merge.py ./temp/prophage_coord.txt max_length
    ...
    python ./background/blast_parse.py ./temp/merged_prophage_coord.txt $outfile $length_var $area_flag $start_end
    ...
    python ./background/mat_gen.py $filename ./temp/merged_prophage_coord.txt $strain_len
